  ...
  return (
    <SkillsContainer ref={sectionRef} id="skills">
      <div className="container">
        <SectionLabel initial={{ opacity: 0 }} animate={isIntersecting ? { opacity: 0.6 } : { opacity: 0 }} transition={{ duration: 0.6 }}>{'// Combat Stats'}</SectionLabel>
        <SectionTitle initial={{ opacity: 0, y: 30 }} animate={isIntersecting ? { opacity: 1, y: 0 } : { opacity: 0, y: 30 }} transition={{ duration: 0.6 }}>Combat Skills</SectionTitle>
        <SectionSubtitle initial={{ opacity: 0 }} animate={isIntersecting ? { opacity: 1 } : { opacity: 0 }} transition={{ duration: 0.6, delay: 0.1 }}>Weapons in the digital arsenal</SectionSubtitle>
