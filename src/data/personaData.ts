...
export const personas: PersonaConfig[] = [
  ...
  },
  {
    id: 'branding',
    title: 'VANGUARD',
    subtitle: 'Brand Commander',
    description: 'Brand Builder. Marketing Strategist. Visual Storyteller. Leading the brand offensive.',
    accentColor: '#fbbf24',
    secondaryColor: '#78350f',
    tagline: 'COMMANDING THE BRAND FRONTLINE',
    stats: [
